...
//            markerAnnotationView.rightCalloutAccessoryView = rightButton
    ...
    func mapView(_ mapView: MKMapView, didSelect view: MKAnnotationView) {
        if let annotation = view.annotation,
            ...
            _ = wikipediaVC.view
            let url = URL(string: "https://en.wikipedia.org/wiki/\(treeAnnotation.feature.properties.genusName.capitalized)_\(treeAnnotation.feature.properties.speciesName.lowercased())")!
